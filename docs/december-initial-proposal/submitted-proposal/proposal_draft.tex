...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
            \node[inner sep=0pt] (img) at (0,0) {\includegraphics[width=\textwidth]{resources/wing-drone.png}};
            \draw [line width=1pt] (img.north west) rectangle (img.south east);
        \end{tikzpicture}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
            \node[inner sep=0pt] (img) at (0,0) {\includegraphics[width=\textwidth]{resources/zipline-drone.png}};
            \draw [line width=1pt] (img.north west) rectangle (img.south east);
        \end{tikzpicture}
